  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="text-sm border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-lg focus:ring-primary focus:border-primary p-2 pr-8 outline-none cursor-pointer hover:border-primary/50 transition-colors"
      >
