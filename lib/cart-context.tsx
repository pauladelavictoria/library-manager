  ...
  return (
    ...
    >
      ...
      <React.Suspense fallback={null}>
        <CartPromoEffect isLoaded={isLoaded} appliedPromo={appliedPromo} applyPromo={applyPromo} />
      </React.Suspense>
    </CartContext.Provider>
  );
}

function CartPromoEffect({ 
  isLoaded, 
  appliedPromo, 
  applyPromo 
}: { 
  ...
  }, [searchParams, isLoaded, appliedPromo, applyPromo]);
  return null;
}
